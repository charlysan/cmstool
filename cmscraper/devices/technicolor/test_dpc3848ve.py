...
class TestDPC348ve(unittest.TestCase):
    ...
    def test_parse_web_page(self, mock_get):
        ...
        pwr_expected_list = [6.3, 11.0, 10.6, 10.7, 11.4, 11.3, 10.5, 10.3, 10.3, 8.1, 8.4, 7.4, 6.8, 7.2, 6.9, 8.2, 6.9, 6.0, 5.9, 5.6, 5.5, 4.8, 3.7, 4.6]  
        snr_expected_list = [34.48, 37.35, 37.09, 36.61, 36.61, 36.61, 36.61, 36.38, 36.61, 35.08, 35.59, 30.82, 32.32, 34.92, 34.48, 35.59, 34.48, 34.48, 34.48, 34.34, 34.34, 34.34, 33.83, 33.83]
